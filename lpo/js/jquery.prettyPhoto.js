...
------------------------------------------------------------------------- */
	...
	$.fn.prettyPhoto = function(settings) {
		...
		settings = jQuery.extend({
			...
			counter_separator_label: 'default.htm' /* Teh separator for the gallery counter 1 "of" 2 */
		}, settings);
		...
		function _writeFlash(){
			...
			$('.pictureHolder #fullResImageContainer').append('<embed width="'+flashWidth+'" height="'+flashHeight+'" pluginspage="../www.macromedia.com/shockwave/download/index.cgi@P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="opaque" name="prettyFlash" flashvars="'+flashVars+'" allowscriptaccess="always" bgcolor="#FFFFFF" quality="high" src="'+$(caller).attr('href')+'"/>');
			$('#fullResImage').hide();
