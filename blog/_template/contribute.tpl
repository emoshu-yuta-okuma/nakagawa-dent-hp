...
<title>{=$title=}｜{=$base_title=}｜千代田区秋葉原の歯医者｜中川歯科クリニック</title>
<ONIf condition="$description_Value">
  <meta name="description" content="{=$description_Value=}" />
  <ELSEIf>
  <meta name="description" content="{=$title=},千代田区秋葉原の「中川歯科クリニック」は、秋葉原駅から徒歩3分という立地にある歯医者です。長きにわたってお口の健康を維持できることを願って予防歯科に力を入れており、マウスピース矯正やメインテナンスのために専用のフロアをご用意しています。" />
</ONIf>
<ONIf condition="$keywords_Value">
  <meta name="keywords" content="{=$title=},秋葉原,歯科,歯医者,千代田区,予防歯科" />
  <ELSEIf>
</ONIf>
...
<div id="wrapper">
  ...
  <div id="main" class="clearfix">
    ...
    <div id="content">
      ...
      <div class="section">
        <div class="section">
          ...
          {=$text1_Value=}
          <div class="center"> <a href="../" class="btn btn-default"> 戻る </a> </div>
          <!-- *********    /CONTENTS ********* --> 
    ...
    <div id="navi">
      ...
      <p class="mt10"><a href="../../lpo/" target="_blank"><img src="../../images/navi_bnr08_off.jpg" width="240" height="80" alt="寝ている間に歯並び矯正 DENマウスピース矯正" /></a></p>
