...
<title>{=$current_category_name=}｜{=$base_title=}｜千代田区秋葉原の歯医者｜中川歯科クリニック</title>
<meta name="keywords" content="{=$current_category_name=},秋葉原,歯科,歯医者,千代田区,予防歯科" />
<meta name="description" content="{=$current_category_name=},千代田区秋葉原の「中川歯科クリニック」は、秋葉原駅から徒歩3分という立地にある歯医者です。長きにわたってお口の健康を維持できることを願って予防歯科に力を入れており、マウスピース矯正やメインテナンスのために専用のフロアをご用意しています。" />
